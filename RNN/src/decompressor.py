...
def main():
        ...
        np.random.seed(0)
        print("------------------------------------------------------------------------------------------------")
        print(args.input_file_prefix+'.params')
        print(args.input_file_prefix+'.combined')
        print("------------------------------------------------------------------------------------------------")
        f = open(os.path.abspath(os.path.join(current_path, os.pardir))+'\\data\\compressed\\'+args.input_file_prefix+'.compressed.params','r')
        ...
        f = open(os.path.abspath(os.path.join(current_path, os.pardir)) + '\\data\\compressed\\'+args.input_file_prefix+'.compressed.combined','rb')
        ...
        f = open(os.path.abspath(os.path.join(current_path, os.pardir)) + "\\data\\decompressed\\" + args.output_file_name,'wb')
        print(id2char_dict)
        print(series[:10])
